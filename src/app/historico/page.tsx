...
export default function HistoricoPage() {
    ...
    return (
        <div className="max-w-2xl mx-auto px-4 md:px-8 pt-6 pb-28 md:pb-10">
            <div className="space-y-5">
                ...
                >
                    <button
                        ...
                        className="p-1.5 rounded-lg hover:bg-white/5 text-muted-foreground hover:text-foreground transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500"
                    >
                    ...
                    <button
                        ...
                        className="p-1.5 rounded-lg hover:bg-white/5 text-muted-foreground hover:text-foreground transition-colors disabled:opacity-30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500"
                    >
                        ...
                        {loading ? (
                            ...
                            <div className="text-center py-10" role="status">
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Nenhuma conta em {mesLabel}
                                </p>
                            </div>
                        ) : (
                            <ul className="space-y-3 list-none" aria-label={`${contas.length} contas em ${mesLabel}`}>
                                {contas.map((conta) => (
                                    <li key={conta.id}>
                                        <ContaCard
                                            conta={conta}
